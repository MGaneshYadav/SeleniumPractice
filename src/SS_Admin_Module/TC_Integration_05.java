...
public class TC_Integration_05 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement phoneNumberTextfield = driver.findElement(By.id("Phone Number"));
		phoneNumberTextfield.clear();
		JavascriptExecutor js=(JavascriptExecutor) driver;
		js.executeScript("arguments[0].value='6746747980';", phoneNumberTextfield);
		...
		driver.findElement(By.cssSelector("svg[data-testid='PersonIcon']")).click();
		Thread.sleep(2000);
		WebElement phNoText = driver.findElement(By.xpath("(//td)[4]"));
		String expectedphNo="6746747980";
		String actualphNo=phNoText.getText();
		if(actualphNo.equals(expectedphNo))
		{
			System.out.println("Proper Phone Number is displayed.");
		}
		else
		{
			System.out.println("Proper Phone number not displayed.");
		}
		driver.quit();
