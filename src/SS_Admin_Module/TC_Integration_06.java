...
public class TC_Integration_06 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		js.executeScript("arguments[0].value='7479806746';", phoneNumberTextfield);
		...
		String expectedphNo="7479806746";
		String actualphNo=phNoText.getText();
		if(actualphNo.equals(expectedphNo))
		{
			System.out.println("Data is updated and displayed");
		}
		else
		{
			System.out.println("Data not updated and displayed");
		}
		driver.quit();
